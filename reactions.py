...
synergy_list = [
    ...
    (("Volcano", ("Snow", "Snowman", "Avalanche", "Glacier", "Lake")), ("Mountain", "Water"), 150),
    ...
    (("Egg", "Life"), ("Bird", "Empty"), 300), 
    (("Egg", "Love"), ("Bird", "Empty"), 500), 
    ...
    ((("Human", "Beast", "Bird", "Phoenix", "Dragon", "Android", "Plants", "Cactus", "Angler", "Miner", "Pirate", 
        "Vocaloid", "Hero", "Will o' Wisp", "Penguin", "Turtle", "Angel", "Royalty", "Tree", "Forest", "Swamp", 
        "Mangrove"), "Love"), ("No Change"), 8), 

    ((("Human", "Beast", "Phoenix", "Dragon", "Android", "Plants", "Cactus", "Angler", "Miner", 
        "Hero", "Penguin", "Turtle", "Tree", "Forest"), "Music"), ("No Change"), 7),
